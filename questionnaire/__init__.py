...
class Player(BasePlayer):
    ...
    q_image=models.CharField(initial=None,choices=['とてもきれいだと思う','きれいだと思う','どちらでもない','汚いと思う','とても汚いと思う'],verbose_name='あなたの大阪に対するイメージを教えてください。')
    ...
    q_hukeiimage=models.CharField(initial=None,choices=['とてもきれいだと思う','きれいだと思う','どちらでもない','汚いと思う','とても汚いと思う'],verbose_name='「大阪といえばどの風景（場所）を思い浮かべますか。」で答えた場所についてのイメージを教えてください。')
    q_yosa=models.CharField(initial=None,choices=['はい','いいえ','きれい'],verbose_name='上の質問でとても汚いと思うまたは汚いと思うと答えた人にお聞きします。汚いことがその場所の良さでもあると思いますか。(どちらでもない、きれいだと思う、とてもきれいだと思うと答えた人は「きれい」にチェックを入れてください。)',widget=widgets.RadioSelect)
    comment=models.StringField(initial=None,verbose_name='場所のイメージについての質問においてきれい、汚いと思った理由を教えてください。')
    image1=models.StringField(initial=None,verbose_name='下の写真のイメージについて教えてください。',choices=['とてもきれいだと思う','きれいだと思う','どちらでもない','汚いと思う','とても汚いと思う'])
    know1=models.CharField(initial=None,verbose_name='上の写真の風景が大阪にあることを知っていますか。',choices=['はい','いいえ'],widget=widgets.RadioSelect)
    image2=models.StringField(initial=None,verbose_name='下の写真のイメージについて教えてください。',choices=['とてもきれいだと思う','きれいだと思う','どちらでもない','汚いと思う','とても汚いと思う'])
    know2=models.CharField(initial=None,verbose_name='上の写真の風景が大阪にあることを知っていますか。',choices=['はい','いいえ'],widget=widgets.RadioSelect)
    image3=models.StringField(initial=None,verbose_name='下の写真のイメージについて教えてください。',choices=['とてもきれいだと思う','きれいだと思う','どちらでもない','汚いと思う','とても汚いと思う'])
    know3=models.CharField(initial=None,verbose_name='上の写真の風景が大阪にあることを知っていますか。',choices=['はい','いいえ'],widget=widgets.RadioSelect)
    image4=models.StringField(initial=None,verbose_name='下の写真のイメージについて教えてください。',choices=['とてもきれいだと思う','きれいだと思う','どちらでもない','汚いと思う','とても汚いと思う'])
    know4=models.CharField(initial=None,verbose_name='上の写真の風景が大阪にあることを知っていますか。',choices=['はい','いいえ'],widget=widgets.RadioSelect)
    image5=models.StringField(initial=None,verbose_name='下の写真のイメージについて教えてください。',choices=['とてもきれいだと思う','きれいだと思う','どちらでもない','汚いと思う','とても汚いと思う'])
    know5=models.CharField(initial=None,verbose_name='上の写真の風景が大阪にあることを知っていますか。',choices=['はい','いいえ'],widget=widgets.RadioSelect)
    image6=models.StringField(initial=None,verbose_name='下の写真のイメージについて教えてください。',choices=['とてもきれいだと思う','きれいだと思う','どちらでもない','汚いと思う','とても汚いと思う'])
