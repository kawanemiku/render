...
class Player(BasePlayer):
    ...
    q_hukeiimage=models.CharField(initial=None,choices=['とてもきれいだと思う','きれいだと思う','わからない','汚いと思う','とても汚いと思う'],verbose_name='「大阪といえばどの風景（場所）を思い浮かべますか。」で答えた場所についてのイメージを教えてください。')
